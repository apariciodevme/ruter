...
const Card = ({text, title, img, btnText}: Props) => {
  return (
    <div className='flex relative pb-5 hover:text-button flex-col mt-10 cursor-pointer hover: rounded-3xl bg-secondary items-center justify-center gap-3 m-7 transition duration-300  hover:bg-[#3d3e45]  '>
      <Image
